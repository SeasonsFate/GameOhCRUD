...
public class GameOfCRUDControllers {
    ...
    @RequestMapping(value = "gameohcrud/add", method = RequestMethod.POST)
    public GameOfCRUD addGameOfCRUD(@RequestBody GameOfCRUD gameOfCRUD){
        return repository.saveAndFlush(gameOfCRUD);
    }

    @RequestMapping(value = "gameohcrud/{id}", method = RequestMethod.GET)
    public GameOfCRUD getGameOfCRUD(@PathVariable Long id){
        return repository.findOne(id);
    }
    @RequestMapping(value = "gameohcrud/{id}",method = RequestMethod.DELETE)
    ...
    @Transactional
    @RequestMapping(value = "gameohcrud/{id}",method = RequestMethod.PUT)
